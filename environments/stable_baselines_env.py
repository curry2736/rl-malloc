...
class StableBaselineEnv(BaseEnv, gym.Env):
    def __init__(self, history_len=0, page_size=50, allocator="ff_bad"):
        ...
        self.observation_space = gym.spaces.Box(low=0, high=page_size, shape=(page_size + 1,), dtype=np.uint8)
    ...
    def _get_state(self, rq):
        ...
        return np.concatenate([bm_copy, rq], axis=0)
